...
export interface AggI<
    ...
    ModelI = convertDBSchemasToDBI<SchemasI>[Plurial<Lowercase<ModelName>> & keyof convertDBSchemasToDBI<SchemasI>],
...
> {
    ...
    project: <Proj extends Projection<ModelI>>(proj: Proj) => AggI<SchemasI, ModelName, ApplyProj<ModelI, Proj>>;
