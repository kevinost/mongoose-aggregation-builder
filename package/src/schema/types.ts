import { Decimal128, Mixed, Types } from 'mongoose';
import { Pretify } from '../utils';

type PreserverOptionalTypesFromShema<New extends Record<string, any>, Original extends Record<string, any>> = Required<
    Pick<New, RequiredProperties<Original> & keyof New>
> &
